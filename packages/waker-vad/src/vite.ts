...
type WakerVadRuntimeAssetsPluginOptions = {
  mountBase?: string;
};

const DEFAULT_MOUNT_BASE = "/waker-vad/";
...
function runtimeRootPath(): string {
  return resolve(import.meta.dirname, "../runtime/vad");
}
...
export function wakerVadRuntimeAssetsPlugin(options: WakerVadRuntimeAssetsPluginOptions = {}) {
