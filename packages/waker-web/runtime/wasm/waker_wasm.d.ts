...
export interface InitOutput {
    ...
    readonly wakerdetectionresult_acceptedWakeForms: (a: number, b: number) => void;
    readonly wakerdetectionresult_chosenWakeForm: (a: number, b: number) => void;
    readonly wakerdetectionresult_detected: (a: number) => number;
    readonly wakerdetectionresult_keyword: (a: number, b: number) => void;
    ...
    readonly wakerwasmdetector_loadBackboneWeights: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
    readonly wakerwasmdetector_loadConfig: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    readonly wakerwasmdetector_melTensorLength: (a: number) => number;
    readonly wakerwasmdetector_new: () => number;
    readonly wakerwasmdetector_processAudioToMel: (a: number, b: number, c: number, d: number) => void;
    readonly wakerwasmdetector_processBackboneOutput: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wakerwasmdetector_processMuLawChunk: (a: number, b: number, c: number, d: number, e: number) => void;
